...
export const User = ({id , email , first_name , last_name , avatar , onClickInvite , isInvite}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickInvite(id)} className="action" src={`/assets/${ isInvite ? "minus" : "plus" }.svg`} alt="Action" />
  </li>
);